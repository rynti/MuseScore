...
public:
    ...
    virtual void seekElement(const notation::EngravingItem* element, SeekOrigin origin, bool flushSound = true) = 0;
    virtual void seekBeat(int measureIndex, int beatIndex, SeekOrigin origin, bool flushSound = true) = 0;
